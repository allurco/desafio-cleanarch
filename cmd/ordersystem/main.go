...
import (
	...
	"github.com/allurco/desafio-cleanarch/internal/event/handler"
	"github.com/allurco/desafio-cleanarch/internal/infra/graph"
	"github.com/allurco/desafio-cleanarch/internal/infra/grpc/pb"
	"github.com/allurco/desafio-cleanarch/internal/infra/grpc/service"
...
func main() {
	...
	createOrderKey := webserver.NewHandleKey("POST", "/order")
	listOrdersKey := webserver.NewHandleKey("GET", "/order")
	webserverInstance.AddHandler(listOrdersKey, webOrderHandler.List)
	webserverInstance.AddHandler(createOrderKey, webOrderHandler.Create)
